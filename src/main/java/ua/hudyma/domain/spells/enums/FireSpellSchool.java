...
public enum FireSpellSchool implements AbstractSpellSchool {
    BLOODLUST (1, BUF, 0, POWER, 1, List.of()),
    CURSE (1, DEBUF, 0, POWER, 1, List.of()),
    ARMAGEDDON(4, DAMAGE, 24, POWER, 40, List.of(30f, 60f, 120f)),
    ...
    SLAYER (4, BUF, 16, POWER, 1, List.of()),
    ...
    LAND_MINES(3, MISC, 18, POWER, 10, List.of(25f, 50f, 100f))
